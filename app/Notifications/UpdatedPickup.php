...
class UpdatedPickup extends Notification implements ShouldQueue
{
    use Queueable;
    private $pickup;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('Pickup Updated')
            ->line('Pickup with tracking No. ('.$this->pickup->pickup_id.') has been updated.')
            ->action('Pickup Updated ('.$this->pickup->pickup_id.')', route('dashboard.pickups.show',$this->pickup->id))
