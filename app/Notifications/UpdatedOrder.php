...
class UpdatedOrder extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Order with tracking No. ('.$this->order->tracking_no.') has been updated.')
            ->action('Order Updated '.$this->order->tracking_no, route('dashboard.orders.show',$this->order->id))
