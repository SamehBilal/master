...
class CreatePickupCustomerLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pickup_customer_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pickup_customer_logs');
    }
}
