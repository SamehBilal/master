...
@section('title')
    {{ __('dashboard.Pickup Customer Logs') }}
@endsection
...
@section('links')
    ...
    <li class="breadcrumb-item active">
        <a href="{{ route('dashboard.pickup-customer-logs.index',$pickup->id) }}">{{ __('dashboard.Pickup Customer Logs') }}</a>
    </li>
    <li class="breadcrumb-item active">
        {{ __('dashboard.create') }}
    </li>
    ...
    <div class="container page__container page-section">
        <div class="page-separator">
            <div class="page-separator__text" >
                {{ __('dashboard.Pickup Customer Logs Information') }}
            </div>
        </div>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-lg-3 bg-light">
                            ...
                            <p class="card-subtitle text-70 mb-16pt mb-lg-0">{{ __('dashboard.Basic details of the user pickup customer Logs listed.') }}</p>
                        </div>
