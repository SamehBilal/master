...
@section('button-link')
    {{ route('dashboard.pickup-logs.create',$pickup->id) }}
@endsection
    ...
    <div class="container page__container">
        <div class="page-section">
            <div class="page-separator">
                <div class="page-separator__text">{{ __('dashboard.Pickup Logs') }}</div>
            </div>
                        ...
                        @foreach($pickup->log as $log)
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <form id="delete-form{{ $log->id }}" action="{{ route('dashboard.pickup-logs.destroy',[$pickup->id,$log->id]) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
