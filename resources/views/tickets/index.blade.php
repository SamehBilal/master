    ...
    {{--@php header("Refresh:15"); @endphp--}}
        ...
        @if (request()->ticket_id || $tickets->first())
            ...
            <div class="container page__container page-section">
                <div class="row">
                    <div class="col-sm-12 col-lg-3" id="email-drawer">
                                ...
                                <div class="col-lg-2" style="margin-top: 4%;">
                                    <a href="{{ route('dashboard.tickets.update', $active_ticket->id) }}"
                                       ...
                                       class="btn btn-outline-secondary">
                                        <i class="fa fa-folder-open icon--left"></i> {{ in_array($active_ticket->status_name,['Closed','Resolved'])? __('dashboard.Closed'): __('dashboard.Close')}}
                                    </a>
                                    @if($active_ticket->status == 1)
