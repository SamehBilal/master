...
@section('main_content')
    <div class="container page__container page-section">
        ...
        <form method="POST" action="{{ route('dashboard.deals.index') }}" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-lg-9 row p-2">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text"
                                           ...
                                           id="en_description"
                                           name="en_description"
                                           placeholder="{{ __('dashboard.en_description') }} ...">{{ old('en_description') }}</textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text"
                                           ...
                                           id="ar_description"
                                           name="ar_description"
                                           placeholder="{{ __('dashboard.ar_description') }} ...">{{ old('ar_description') }}</textarea>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="en_details" name="en_details" rows="5"  class="details form-control">{{ old('en_details') }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-label" for="ar_details">{{ __('dashboard.ar_details') }}:</label><br>
                                    <textarea id="ar_details" name="ar_details" rows="5"  class="details form-control">{{ old('ar_details') }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select id="status" name="status" class="custom-select @error('status') is-invalid @enderror" style="width: 270px;">
                                        <option value="Public" {{ old('status') == 'Public'?'selected':'' }}>{{ __('dashboard.Public') }}</option>
                                        <option value="Private" {{ old('status') == 'Private'?'selected':'' }}>{{ __('dashboard.Private') }}</option>
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
