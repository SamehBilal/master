...
@section('links')
    ...
    <li class="breadcrumb-item ">
        <a href="{{ route('dashboard.hubs.show',$hub->id) }}">{{ $hub->name }}</a>
    </li>
...
@section('main_content')
    <div class="container page__container page-section">
        ...
        <form method="POST" action="{{ route('dashboard.hubs.update',$hub->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-body ">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('ar_name') ? old('ar_name'):$hub->ar_name }}"
                                           id="ar_name"
                                           name="ar_name"
                                           required="required"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('en_name') ? old('en_name'):$hub->en_name }}"
                                           id="en_name"
                                           name="en_name"
                                           required="required"
