...
@section('button-link')
    {{ route('dashboard.order-logs.create',$order->id) }}
@endsection
    ...
    <div class="container page__container">
        <div class="page-section">
            <div class="page-separator">
                <div class="page-separator__text">{{ __('dashboard.Order Logs') }}</div>
            </div>
                        ...
                        @foreach($order->log as $log)
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <form id="delete-form{{ $log->id }}" action="{{ route('dashboard.order-logs.destroy',[$order->id,$log->id]) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
