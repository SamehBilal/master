                            ...
                            <div class="popoverContainer d-none">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="card-title mb-0">{{ $order->courier ? $order->courier->full_name:'' }}</div>
                                        <p class="lh-1">
                                            <span class="text-50 small">created</span>
                                            <span class="text-50 small font-weight-bold">{{ $order->updated_at }}</span>
                                        </p>
                                    </div>
                                </div>
                                @endif
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex">
                                                    <div class="card-title">{{ $order->courier ? $order->courier->full_name:'' }}</div>
                                                    <p class="flex text-50 lh-1 mb-0"><small>{{ $order->courier ? $count_order = \App\Models\Order::where('courier_user_id',$order->courier_user_id)->count(): $count_order ='' }} order(s)</small></p>
                                                </div>
                                                @else
                                                    <a href="{{ route('dashboard.orders.courier',$order->id) }}"
                                                       class="btn btn-primary">Edit Courier</a>
