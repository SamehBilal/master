                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('fax') ? old('fax'):$customer->fax }}"
                                                   autocomplete="fax"
                                                   name="fax"
                                                   id="fax"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('country') ? old('country'):$customer->country }}"
                                                   required="required"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('city') ? old('city'):$customer->city }}"
                                                   required="required"
                                                   autocomplete="city"
                                                   name="city"
                                                   id="city"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('floor') ? old('floor'):$customer->floor }}"
                                                   required="required"
                                                   autocomplete="floor"
                                                   name="floor"
                                                   id="floor"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('apartment') ? old('apartment'):$customer->apartment }}"
                                                   required="required"
                        ...
                        <div class="flex"
                                ...
                                <div class="media align-items-center">
                                    <a href="#"
                                       class="media-left mr-16pt">
                                        <img src="{{ $customer->avatar ? asset('backend/images/people/110/guy-3.jpg'): asset('storage/user/'.$customer->avatar)}}"
                                             alt="people"
                                             width="56"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="text"
                                           ...
                                           value="{{ old('profile_name') ? old('profile_name'):$customer->profile_name }}"
                                           name="profile_name"
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="3"
                                          ...
                                          name="bio">{{ old('bio') ? old('bio'):$customer->bio }}</textarea>
                                @error('bio')
                                <div class="invalid-feedback" role="alert">{{ $message }}</div>
                                @enderror
                                <div class="valid-feedback">Looks good!</div>
